...
MediaCategory.streaming,
  ...
  Size get iconSize => switch (this) {
    MediaPlatform.youtube => const Size(19, 19),
        MediaPlatform.disney ||
        MediaPlatform.onetrust ||
    MediaPlatform.okx =>
          const Size(19, 19),
    MediaPlatform.netflix || MediaPlatform.gemini => const Size(18, 18),
    MediaPlatform.ehentai || MediaPlatform.npm ||
    MediaPlatform.unpkg => const Size(16, 16),
    _ => const Size(17, 17),
  };
}
